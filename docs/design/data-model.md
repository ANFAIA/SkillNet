...
**This document describes the v1 schema and is not rewritten here.** Everything below v1 is still
accurate and still what production runs with `DYNAMIC_COURSES_MODE=off`.

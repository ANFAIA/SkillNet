...
const es = {
  ...
  vision: {
    ...
    body3:
      "La siguiente frontera es generar la propia experiencia interactiva, además de elegir entre formatos existentes. Con los modelos actuales todavía resulta caro y lento hacerlo bien. A medida que evolucionen, podrán crear interfaces más complejas en menos tiempo y con un coste menor, hasta hacer viable este tipo de generación en más cursos y para más personas.",
    body4:
      "Un curso de animación podría no limitarse a mostrar un vídeo sobre animación: también podría generar un simulador de fotogramas para que cada persona experimente con sus propias manos. Eso todavía no es viable a escala, pero es la dirección que SkillNet quiere explorar.",
    formatDiagramLabel: "De copiar un formato a crear un lenguaje propio",
    previousFormat: "Formato anterior",
    previousFormatDetail: "Una lección impresa o presencial",
    screenCopy: "Copia en pantalla",
    screenCopyDetail: "La misma estructura en un soporte digital",
    ownLanguage: "Lenguaje propio",
    ownLanguageDetail: "Una experiencia modular e interactiva",
    compositionLabel: "OpenUI y los componentes Didact",
    openUiDetail: "Genera la estructura y presentación de la interfaz.",
    didactDetail: "Biblioteca de componentes creados para aprender.",
    explanation: "Explicación",
    practice: "Práctica",
    simulation: "Simulación",
    support: "Apoyo",
    signalsLabel: "Señales que SkillNet puede tener en cuenta",
    preferences: "Preferencias",
    role: "Rol",
    level: "Nivel",
    progress: "Progreso",
    trendsLabel: "Cómo puede evolucionar la generación de experiencias",
    trendsTitle: "Modelos más capaces",
    moreCapableModels: "hacia el futuro",
    personalization: "Personalización",
    complexity: "Complejidad",
    time: "Tiempo",
    cost: "Coste",
    reach: "Alcance",
    simulatorLabel: "Ejemplo de un simulador de fotogramas",
    simulatorTitle: "Simulador de fotogramas",
    simulatorDetail: "Explora el movimiento ajustando los fotogramas.",
    simulatorInstruction: "Selecciona un fotograma y arrastra manos, pies o cadera.",
    simulatorHip: "Mover cadera",
    simulatorLeftHand: "Mover mano izquierda",
    simulatorRightHand: "Mover mano derecha",
    simulatorLeftFoot: "Mover pie izquierdo",
    simulatorRightFoot: "Mover pie derecho",
    playLabel: "Reproducir animación",
    pauseLabel: "Pausar animación",
    onionSkin: "Fotogramas previos",
    today: "Hoy",
  },
  builtWith: {
...
const en: typeof es = {
  ...
  vision: {
    ...
    body3:
      "The next frontier is generating the interactive experience itself, as well as choosing between existing formats. With today's models, doing this well is still expensive and slow. As they evolve, they will be able to create more complex interfaces in less time and at a lower cost, making this kind of generation viable for more courses and more learners.",
    body4:
      "An animation course could go beyond showing a video about animation: it could also generate a frame simulator so each person can experiment directly. That is not viable at scale yet, but it is the direction SkillNet wants to explore.",
    formatDiagramLabel: "From copying a format to creating a language of its own",
    previousFormat: "Previous format",
    previousFormatDetail: "A printed or in-person lesson",
    screenCopy: "Copied to a screen",
    screenCopyDetail: "The same structure on a digital medium",
    ownLanguage: "A language of its own",
    ownLanguageDetail: "A modular, interactive experience",
    compositionLabel: "OpenUI and Didact components",
    openUiDetail: "Generates the structure and presentation of the interface.",
    didactDetail: "A library of components created for learning.",
    explanation: "Explanation",
    practice: "Practice",
    simulation: "Simulation",
    support: "Support",
    signalsLabel: "Signals SkillNet can take into account",
    preferences: "Preferences",
    role: "Role",
    level: "Level",
    progress: "Progress",
    trendsLabel: "How experience generation could evolve",
    trendsTitle: "More capable models",
    moreCapableModels: "towards the future",
    personalization: "Personalization",
    complexity: "Complexity",
    time: "Time",
    cost: "Cost",
    reach: "Reach",
    simulatorLabel: "Example of a frame simulator",
    simulatorTitle: "Frame simulator",
    simulatorDetail: "Explore movement by adjusting its frames.",
    simulatorInstruction: "Choose a frame, then drag its hands, feet, or hips.",
    simulatorHip: "Move hips",
    simulatorLeftHand: "Move left hand",
    simulatorRightHand: "Move right hand",
    simulatorLeftFoot: "Move left foot",
    simulatorRightFoot: "Move right foot",
    playLabel: "Play animation",
    pauseLabel: "Pause animation",
    onionSkin: "Previous frames",
    today: "Today",
  },
  builtWith: {

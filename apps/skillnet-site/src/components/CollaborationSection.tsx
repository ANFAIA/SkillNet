  ...
  return <section id="open-source" data-nav-theme="light" className="w-full scroll-mt-24 bg-white px-6 py-20 sm:px-10 sm:py-28">
    <div className="mx-auto w-full max-w-[80%]">
      ...
      <motion.div initial={false} className="open-source-row mt-10">
        <div className="open-source-copy"><span className="open-source-status"><Wrench size={15} strokeWidth={1.8} aria-hidden="true" /> Versión en desarrollo</span><div><p>SkillNet se construye en abierto: el código puede revisarse, ejecutarse y mejorarse públicamente. Es self-hosted, con el proveedor de IA que elijas o con modelos locales, y su API, el servicio A2A y el servidor MCP permiten usarlo desde otras herramientas. Licencia Apache 2.0.</p><p>La instancia y sus datos quedan bajo tu control; si eliges un proveedor externo, el tratamiento del contenido dependerá de su configuración.</p></div></div>

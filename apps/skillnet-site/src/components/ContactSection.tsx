    ...
    <div className="mx-auto w-full max-w-[80%]">
      <div className="contact-grid">
        <div className="contact-intro">
          ...
          <motion.p initial={false} className="type-lead mt-6 text-[var(--color-text-secondary)]">SkillNet se construye en abierto. Estamos abiertos a dudas, ideas, colaboraciones y a cualquiera que quiera probarlo o aportar al proyecto.</motion.p>

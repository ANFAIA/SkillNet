...
export default function StableAdaptSection() {
  return <section className="education-section w-full bg-white px-6 py-20 sm:px-10 sm:py-28">
    <div className="mx-auto w-full max-w-[80%]">
      ...
      <motion.p initial={false} className="education-copy mt-10">Un horizonte: experiencias, no catálogo. Hoy SkillNet ya hace Generative UI: sabe qué domina cada persona, guarda sus notas de aprendizaje y elige el formato más adecuado para ella (texto, imagen, vídeo, audio).</motion.p>

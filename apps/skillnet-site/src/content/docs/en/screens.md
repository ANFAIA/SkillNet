...
**Route:** `/empleado/ajustes`. The account menu and the side navigation link to this screen
as "Learning preferences". The employee can change presentation, detail, image treatment, and
accessibility without repeating onboarding.
**Role:** employee

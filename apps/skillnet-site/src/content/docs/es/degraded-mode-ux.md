---
title: "Modo degradado: exponerlo en la interfaz"
order: 26
section: "core"
---
...
**Relacionado:** [`onboarding.md`](/docs/onboarding) §2, [`media-artifacts.md`](/docs/media-artifacts) §5,
[`configuration.md`](/docs/configuration), [`security.md`](/docs/security)

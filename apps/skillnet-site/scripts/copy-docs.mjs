...
const entries = [
  ...
  { slug: "semantic-boundaries", title: "Fronteras semánticas", titleEn: "Semantic boundaries", order: 51, section: "research", src: join(repoRoot, "docs/research/semantic-boundaries/README.md") },
  { slug: "semantic-boundaries-classification", title: "Clasificación basada en contenido", titleEn: "Content-based classification", order: 52, section: "research", src: join(repoRoot, "docs/research/semantic-boundaries/content-based-classification.md") },
  { slug: "semantic-boundaries-dsac-bench", title: "Banco DSAC", titleEn: "DSAC bench", order: 53, section: "research", src: join(repoRoot, "docs/research/semantic-boundaries/experiments/dsac-bench.md") },
  { slug: "semantic-boundaries-experiment-log", title: "Registro de experimentos", titleEn: "Experiment log", order: 54, section: "research", src: join(repoRoot, "docs/research/semantic-boundaries/experiments/experiment-log.md") },
  { slug: "generative-ui-research", title: "UI generativa (investigación)", titleEn: "Generative UI (research)", order: 55, section: "research", src: join(repoRoot, "docs/research/generative-ui/README.md") },
  { slug: "generative-ui-benchmarks", title: "Bancos de prototipos", titleEn: "Prototype benchmarks", order: 56, section: "research", src: join(repoRoot, "docs/research/generative-ui/experiments/prototype-benchmarks.md") },
  { slug: "multi-agent-coordination", title: "Coordinación multiagente", titleEn: "Multi-agent coordination", order: 57, section: "research", src: join(repoRoot, "docs/research/multi-agent-coordination/README.md") },
  { slug: "multi-agent-communication", title: "Comunicación entre agentes", titleEn: "Agent communication", order: 58, section: "research", src: join(repoRoot, "docs/research/multi-agent-coordination/agent-communication.md") },
  { slug: "post-markdown", title: "Post-Markdown", titleEn: "Post-Markdown", order: 59, section: "research", src: join(repoRoot, "docs/research/post-markdown/README.md") },
  { slug: "post-markdown-md-reader", title: "Cómo funciona md-reader", titleEn: "How md-reader works", order: 60, section: "research", src: join(repoRoot, "docs/research/post-markdown/how-md-reader-works.md") },
  { slug: "inference-acceleration", title: "Aceleración de inferencia", titleEn: "Inference acceleration", order: 61, section: "research", src: join(repoRoot, "docs/research/inference-acceleration/README.md") },
  { slug: "inference-lora-serving", title: "Opciones de servicio LoRA", titleEn: "LoRA serving options", order: 62, section: "research", src: join(repoRoot, "docs/research/inference-acceleration/lora-serving-options.md") },
  { slug: "inference-needle-router", title: "Needle router", titleEn: "Needle router", order: 63, section: "research", src: join(repoRoot, "docs/research/inference-acceleration/needle-router.md") },
  { slug: "inference-production-roadmap", title: "Hoja de ruta de producción", titleEn: "Production roadmap", order: 64, section: "research", src: join(repoRoot, "docs/research/inference-acceleration/production-roadmap.md") },
];

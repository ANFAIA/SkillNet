    ...
    <aside className="fixed left-0 top-0 bottom-0 w-[248px] frame-surface flex flex-col z-20">
      ...
      <div className="mx-5 mb-5 p-4 rounded-xl bg-white/10 border border-white/10">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-white/90 text-xs font-semibold">¿Necesitas ayuda?</span>
        </div>
        <p className="text-white/50 text-[11px] leading-relaxed mb-3">Pregunta al asistente sobre cursos, empleados o la plataforma.</p>
        <NavLink
          to="/admin/chat"
